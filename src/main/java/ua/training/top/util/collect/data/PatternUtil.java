...
public class PatternUtil {
    public static Pattern
            ...
            pattern_is_contain_number = Pattern.compile("[\\d\\.]+", Pattern.CASE_INSENSITIVE),
            ...
            pattern_salaries_linkedin = Pattern.compile("[\\d,\\.\\sk]++\\s.{0,2}((c(ad?)?\\$)|(cad)|(usd)|\\p{Sc})|" +
                    "([\\d,\\.\\sk]++[-\\s]*[\\d,\\.\\sk]++)|((\\p{Sc}[[\\d,\\.\\sk]\\s-]*)*)", Pattern.CASE_INSENSITIVE),
