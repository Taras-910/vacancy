...
public class PatternUtil {
    public static final Pattern pattern_find_salary = Pattern
            .compile("([\\p{Sc}\\p{Pd}]\\s*\\d[\\p{Sc}\\p{Zs}\\d\\.,\\s]+[k\\p{Zs}]*?)|(\\d[\\d\\.,\\s\\p{Zs}]+[k\\p{Zs}]*?\\s*[\\p{Sc}\\p{Pd}доup])", Pattern.CASE_INSENSITIVE);
