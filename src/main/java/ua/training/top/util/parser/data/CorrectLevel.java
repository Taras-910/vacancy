...
public class CorrectLevel {
    ...
    public static String getLevelGrc(String level) {
        switch (level) {
            case "intern" -> level = "employment=probation";
