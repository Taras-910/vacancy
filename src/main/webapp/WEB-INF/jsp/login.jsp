...
<div class="container lead py-3">
    ...
    по локации и<br/>по языку программирования, пользователь может индивидуально отмечать вакансии, цвет строк
    изменяется,<br/>данные  запоминаются в базе.<br/>Весь REST интерфейс покрывается JUnit тестами, используется
    Spring MVC Test и Spring Security Test.<br/>
