...
<div class="container lead py-3">
    ...
    вакансии, обновлять базу данных, пользователи могут управлять своим профилем, обновлять базу данных, отмечать
    выбранные вакансии (изменяется цвет строки, сохраняется индивидуальный выбор) через UI (по AJAX) и по REST интерфейсу
    с базовой авторизацией. Вакансии можно фильтровать / обновлять по языку программирования, профессиональному уровню,
    локации.<br/>Весь REST интерфейс покрывается JUnit тестами, при этом используется Spring MVC Test и Spring Security
    Test.<br/>БД хранит актуальные вакансии (не старше 2-х недельной давности), авто-обновляется по 12 ресурсам:<br/>
