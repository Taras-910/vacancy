...
public class RateTestData {
    ...
    public static final Rate rate9 = new Rate(RATE1_ID + 8,  "USDBGN", 1.9701, of(2020,10,25));
    public static final Rate rate10 = new Rate(RATE1_ID + 9,  "USDBYR", 2.52, of(2020,10,25));
    ...
    public static List<Rate> allRates(){
        return Arrays.asList(rate9, rate10, rate8, rate7, rate6, rate5, rate4, rate3, rate2, rate1);
    }
}
